...
public class DynamoDBXACommitExceptionTest extends DynamoDBCommitExceptionTest {
    private static final Logger LOG = LoggerFactory.getLogger(DynamoDBXACommitExceptionTest.class);
