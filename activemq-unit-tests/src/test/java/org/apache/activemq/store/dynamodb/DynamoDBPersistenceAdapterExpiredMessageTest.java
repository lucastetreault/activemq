...
public class DynamoDBPersistenceAdapterExpiredMessageTest {
    private static final Logger LOG = LoggerFactory.getLogger(DynamoDBPersistenceAdapterExpiredMessageTest.class);
