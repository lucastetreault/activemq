...
public class DynamoDBMessagePriorityTest extends MessagePriorityTest {

    private static final Logger LOG = LoggerFactory.getLogger(DynamoDBMessagePriorityTest.class);
    ...
    public static Test suite() {
        return suite(DynamoDBMessagePriorityTest.class);
    }
